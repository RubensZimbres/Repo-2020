...
begin
  ...
  se (isBought = false) e ((ZeroLAG_MACD-ZeroLAG_MACD_Sinal) > 0) e (MACD(35,14,9)|1|>-0.01) então
  ...
  senão se (MACD(35,14,9)|1|<0.06) e ((ZeroLAG_MACD-ZeroLAG_MACD_Sinal) < 0) então
    inicio
